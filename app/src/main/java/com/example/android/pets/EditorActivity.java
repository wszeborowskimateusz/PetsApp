...
public class EditorActivity extends AppCompatActivity
    ...
    //Uri from the Intent
    private Uri mCurentPetUri;

    //Check if any data was edited in editing mode in order to display diaog
    private boolean mPetHasChanged = false;

    //Listener if any view was changed
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set up the listener on the views
    ...
    //Get users input from editor and save it into the db
    private void savePet(){
        ...
        //Editing mode
            ...
            int rows = getContentResolver().update(mCurentPetUri,values,null,null);
            if(rows > 0){
    ...
    //Display dialog if the user wants to exit the editing activity
    ...
    private void deletePet() {
        if(mCurentPetUri != null){
            int rows = getContentResolver().delete(mCurentPetUri,null,null);
            if(rows > 0){
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        if(mCurentPetUri != null)return new android.content.CursorLoader(this,mCurentPetUri,projections,"id=",null,null);
        else return null;
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        if(cursor.moveToFirst()) {
            //Set the proper information based on db
            ...
            mWeightEditText.setText(String.valueOf(cursor.getInt(cursor.getColumnIndexOrThrow(PetEntry.COLUMN_PET_WEIGHT))));
